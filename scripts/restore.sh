...
#   ./scripts/restore.sh /backup/sm-devsecops/20260916_020000.sql.gz
#   ./scripts/restore.sh -f /backup/sm-devsecops/20260916_020000.sql.gz   # 非交互，跳过确认
#
# 环境变量：
...
DB_NAME="${DB_NAME:-sm_devsecops_db}"
